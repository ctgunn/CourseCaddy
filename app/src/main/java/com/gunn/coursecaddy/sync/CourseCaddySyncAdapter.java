...
import com.gunn.coursecaddy.MainActivity;
import com.gunn.coursecaddy.R;
import com.gunn.coursecaddy.Utility;
import com.gunn.coursecaddy.data.GolfNowContract;
 ...
 */
public class CourseCaddySyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = CourseCaddySyncAdapter.class.getSimpleName();
...
//            GolfNowContract.WeatherEntry.COLUMN_SHORT_DESC
    };
...
//                getContext().getContentResolver().bulkInsert(GolfNowContract.WeatherEntry.CONTENT_URI, cvArray);
//
//                // delete old data so we don't build up an endless history
//                getContext().getContentResolver().delete(GolfNowContract.WeatherEntry.CONTENT_URI,
//                        GolfNowContract.WeatherEntry.COLUMN_DATE + " <= ?",
//                        new String[] {Long.toString(dayTime.setJulianDay(julianStartDay-1))});
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        CourseCaddySyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
